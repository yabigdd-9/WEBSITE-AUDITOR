---
title: "35. EMBEDDED WEBSITE-AUDITOR V32 CANONICAL PROJECT PLAN"
brain_version: "7.0.0"
...
# 35. EMBEDDED WEBSITE-AUDITOR V32 CANONICAL PROJECT PLAN

This is the complete validated YAML plan merged into V7 for portability.

**Selective-load rule:** agents should load this section only when working on WEBSITE-AUDITOR planning/implementation.

**Canonical repository:** `/Users/dd/WEBSITE-AUDITOR`

**Experimental/reference repository:** `/Users/dd/Downloads/WEBSITE-AUDITOR-master`

**Core runtime:** `launchd + ./mm supervisor + SQLite`

**Human-facing operator workspace:** `CatalyxLabs` Obsidian vault

**n8n:** not required by the default stack
